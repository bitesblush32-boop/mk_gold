...
export function MkPledgedCalculator() {
  ...
  const goldValue =
    weightNum > 0 ? Math.round(rateMap[purity] * weightNum * 0.975) : null;
  ...
  return (
    ...
    >
      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            {[
              {
                label: "Gold value (estimated)",
                value: goldValue !== null ? fmt(goldValue) : "—",
              },
              {
                label: "Outstanding loan",
                value: loanNum > 0 ? fmt(loanNum) : "—",
              },
            ].map(({ label, value }) => (
              <div
                key={label}
            ...
            {hasResult && !isPositive && (
              ...
              >
                Your outstanding loan appears to exceed the gold&apos;s current
                value. Please call a branch — we can still help you explore your
                options.
              </p>
            )}
          </>
      ...
      >
        Estimate only. Branch confirmation required. Exact payout subject to
        live MCX rate and XRF purity test.
      </p>
