...
export function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mk-admin-shell">
      ...
      >
        <span
          className={`mk-admin-ham-bar${open ? " mk-admin-ham-bar--top-open" : ""}`}
        />
        <span
          className={`mk-admin-ham-bar${open ? " mk-admin-ham-bar--mid-open" : ""}`}
        />
        <span
          className={`mk-admin-ham-bar${open ? " mk-admin-ham-bar--bot-open" : ""}`}
        />
      </button>
      ...
      {/* Sidebar */}
      <aside
        className={`mk-admin-sidebar${open ? " mk-admin-sidebar--open" : ""}`}
      >
        {/* Logo */}
        <div className="mk-admin-sidebar__logo">
          ...
          >
            ...
            >
              ...
              <span style={{ color: "var(--white)", letterSpacing: "0.07em" }}>
                {" "}
                GOLD
              </span>
            </div>
      ...
      {/* Main content */}
      <main className="mk-admin-main">{children}</main>
    </div>
  );
}
