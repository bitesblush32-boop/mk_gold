      ...
      <div className="mk-container">
        <div className="mk-footer__grid">
          ...
          <div className="mk-footer__brand">
            ...
            <p className="mk-footer__desc">
              Karnataka&apos;s trusted gold buyer since 2014. Branches across
              Bangalore, Mysore, Mangalore and Davangere. Fair rates, XRF purity
              test, payment in 30 minutes.
            </p>
            ...
            <div className="mk-footer__contact">
              <a
                ...
                className="mk-footer__contact-link"
                aria-label="Call MK Gold"
              >
                +91 70195 00600
              </a>
              <a
                href="mailto:info@mkgold.in"
                className="mk-footer__contact-link"
              >
                info@mkgold.in
              </a>
              <address className="mk-footer__address">
                #29, 2nd floor, 1st Main Rd, 3rd Block, 3rd Stage,
                <br />
            ...
            <div className="mk-footer__social">
              ...
              <a
                href="https://www.instagram.com/mkgold_official/"
                target="_blank"
                rel="noopener noreferrer"
                className="mk-footer__social-link"
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61572106750563"
                target="_blank"
                rel="noopener noreferrer"
                className="mk-footer__social-link"
                aria-label="Facebook"
              ...
              <a
                href="https://x.com/mkgold_official"
                target="_blank"
                rel="noopener noreferrer"
                className="mk-footer__social-link"
              ...
              <a
                href="https://www.youtube.com/@MkGold_official"
                target="_blank"
                rel="noopener noreferrer"
                className="mk-footer__social-link"
                aria-label="YouTube"
              ...
              <a
                href="https://www.linkedin.com/company/mk-gold/"
                target="_blank"
                rel="noopener noreferrer"
                className="mk-footer__social-link"
                aria-label="LinkedIn"
        ...
        <div className="mk-footer__bottom">
          ...
          <nav className="mk-footer__bottom-links" aria-label="Legal links">
            ...
            <Link href="/terms" className="mk-footer__bottom-link">
              Terms
            </Link>
            <span aria-hidden="true">·</span>
            <a
              href="mailto:grievance@mkgold.in"
              className="mk-footer__bottom-link"
            >
              grievance@mkgold.in
            </a>
          </nav>
