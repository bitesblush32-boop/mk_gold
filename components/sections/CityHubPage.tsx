...
function Stars({ rating }: { rating: number }) {
  return (
    <div
      className="mk-review-card__stars"
...
export function CityHubPage({ city }: CityHubPageProps) {
  ...
  const localBusinessSchema = {
    ...
    geo: firstBranch
      ? {
          "@type": "GeoCoordinates",
          latitude: firstBranch.coordinates.lat,
          longitude: firstBranch.coordinates.lng,
        }
      : undefined,
    ...
    <main>
      ...
      >
        <div className="mk-container">
          <div className="reveal" style={{ maxWidth: "720px" }}>
            ...
            >
              {n} {n === 1 ? "branch" : "branches"} across {city}. Same process.
              Same promise.
            </p>
      ...
      >
        <div className="mk-container mk-hub-rate-banner__inner">
          <span className="mk-hub-rate-banner__label">
            Live rate — updated every 5 min
          </span>
      ...
      >
        <div className="mk-container">
          ...
          <div
            className="mk-hub-pill-grid"
            aria-label={`MK Gold branch areas in ${city}`}
          >
            {branches.map((branch) => (
              <a
                key={branch.slug}
          ...
          <div className="mk-reviews__grid">
            {testimonials.map((r, i) => (
              ...
              >
                ...
                <span className="mk-review-card__deco-quote" aria-hidden="true">
                  &ldquo;
                </span>
                ...
                <footer className="mk-review-card__footer">
                  <div className="mk-review-card__author-row">
                    ...
                    <div className="mk-review-card__author-info">
                      <strong className="mk-review-card__author">
                        {r.author}
                      </strong>
                  ...
                  <span
                    className="mk-review-card__source"
