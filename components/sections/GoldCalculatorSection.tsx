          ...
          <div className="gc-card__inputs">
            <div className="gc-fields-row">
              <div className="gc-field">
                <label className="gc-label" htmlFor="gc-weight">Enter Weight</label>
              ...
              <div className="gc-field">
                <label className="gc-label" htmlFor="gc-purity">Select Purity</label>
            ...
            <p className="gc-rate-line">
              ...
              <strong>
                {isLoading || activeRate === 0 ? '—' : `${fmt(activeRate)}/gram`}
              </strong>
            </p>
