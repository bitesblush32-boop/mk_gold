      ...
      >
        <div className="mk-container">
          <div className="reveal" style={{ maxWidth: '640px' }}>
            ...
            >
              We&apos;re currently active in Bangalore, with {city} opening soon. Same live
              MCX rates, same XRF purity testing, same 30-minute payment — as soon as we
              open here. In the meantime, you&apos;re welcome to visit our Bangalore branches
