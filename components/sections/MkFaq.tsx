...
/* ─── Fallback data (used when no faqs prop is passed) ────────────── */
...
const FALLBACK_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Walk-ins are welcome at all our branches during working hours (Monday to Saturday, 9:30 AM to 7:00 PM). Booking an appointment ensures you are attended to immediately, but it is never required.",
  }, // was: all 16 branches
];
