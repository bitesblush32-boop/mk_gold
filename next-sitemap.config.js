...
const config = {
  ...
  robotsTxtOptions: {
    ...
    // Blog posts have their own dynamic sitemap generated by Next.js App Router
    additionalSitemaps: ["https://mkgold.in/blog/sitemap.xml"],
  },
  ...
  transform: async (cfg, path) => {
    ...
    if (
      ["/sell-gold", "/release-pledged-gold", "/gold-rate-today"].includes(path)
    ) {
