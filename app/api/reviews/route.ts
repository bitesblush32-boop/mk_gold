...
const SEED_REVIEWS: Review[] = [
  {
    ...
    date: "April 2026",
    quote:
      "Excellent service at MK Gold Rajajinagar. Got 97% of market rate for my 22K jewellery. The XRF test was done in front of me — very transparent. Highly recommend.",
  },
  {
    author: "Priya Sharma",
    location: "Bangalore",
    ...
    date: "March 2026",
    quote:
      "I was worried about selling my pledged gold but MK Gold handled everything smoothly. They paid Muthoot directly and gave me the remaining amount immediately. Confidential and professional.",
  },
  {
    author: "Suresh Naidu",
    ...
    date: "February 2026",
    quote:
      "Fast process, fair price, no hassle. Cash in hand in 40 minutes. MK Gold Malleshwaram team was polite and explained the rate calculation clearly. Will return.",
  },
];
...
export async function GET() {
  ...
  if (!apiKey || !placeId) {
    console.warn(
      "[api/reviews] GOOGLE_PLACES_API_KEY or GOOGLE_PLACE_ID not set — using seed reviews",
    );
