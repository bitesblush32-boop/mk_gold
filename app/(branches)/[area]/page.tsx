  ...
  Bangalore: [
    {
      initials: "SK",
      area: "Rajajinagar",
      goldType: "Gold jewellery",
      value: "₹84,000",
      quote:
        "The XRF test was done in front of me. I knew exactly what I was being paid and why.",
    },
    {
      initials: "AR",
      area: "Koramangala",
      goldType: "Old bangles",
      value: "₹43,200",
      quote:
        "Fast process and the staff were respectful throughout. No pressure at any point.",
    },
    {
      initials: "RK",
      area: "Jayanagar",
      ...
      value: "₹1,08,000",
      quote:
        "The MCX rate was shown right next to what they paid. Completely transparent.",
    },
  ],
  Mysore: [
    {
      ...
      value: "₹1,12,000",
      quote:
        "The team explained every step. I felt comfortable the whole time.",
    },
    {
      initials: "PM",
      area: "Mysore City",
      ...
      value: "₹56,500",
      quote:
        "Same-day UPI payment. I did not expect it to be this straightforward.",
    },
    {
      initials: "SV",
      area: "Vijayanagar",
      goldType: "22K necklace",
      value: "₹78,200",
      quote:
        "The weight was checked openly and I could verify it myself. Fair price.",
    },
  ],
  Mangalore: [
    {
      initials: "MR",
      area: "Mangalore",
      goldType: "22K jewellery",
      value: "₹67,500",
      quote:
        "Transparent process and immediate payment. Will come back without hesitation.",
    },
    {
      initials: "VS",
      area: "Kadri",
      goldType: "Broken gold",
      value: "₹28,900",
      quote:
        "Even broken pieces were valued fairly. No deduction for condition.",
    },
    {
      initials: "AD",
      area: "Mangalore",
      ...
      value: "₹1,85,000",
      quote:
        "Professional staff and the payment matched exactly what was quoted.",
    },
  ],
  Davangere: [
    {
      ...
      value: "₹2,45,000",
      quote:
        "Walked in without an appointment and was done in under 40 minutes.",
    },
    {
      initials: "LM",
      area: "Davangere",
      ...
      value: "₹91,500",
      quote:
        "MK Gold handled the pledged gold release smoothly. Highly recommended.",
    },
    {
      initials: "RS",
      area: "Davangere",
      goldType: "Old jewellery",
      value: "₹62,000",
      quote:
        "Honest and professional. The MCX rate was visible throughout the transaction.",
    },
  ],
};

const AREA_DESCRIPTIONS: Record<
  string,
  { description: string; directions: string }
> = {
  "sell-gold-rajajinagar": {
    description: "One of Bangalore's most established residential areas.",
    directions:
      "Near Rajajinagar Main Road, easy reach from Majestic, Yeshwanthpur, and Malleswaram.",
  },
  "sell-gold-malleshwaram": {
    description: "The cultural heart of North Bangalore.",
    directions:
      "Walking distance from 18th Cross commercial area and Sampige Road.",
  },
  "sell-gold-vijayanagar": {
    description: "A central area serving Mahalakshmipuram and Nagarbhavi.",
    directions:
      "Off Chord Road, accessible from Rajajinagar and Basaveshwaranagar.",
  },
  "sell-gold-basaveshwaranagar": {
    description: "Well-connected residential hub in West Bangalore.",
    directions:
      "Near BEL Road junction, accessible from Vijayanagar and Chord Road.",
  },
  "sell-gold-yeshwanthpur": {
    description: "A busy commercial hub close to the railway station.",
    directions:
      "Near Yeshwanthpur railway station, serving North and West Bangalore.",
  },
  "sell-gold-jayanagar": {
    description: "South Bangalore's most popular residential neighbourhood.",
    directions:
      "On Jayanagar 4th Block, accessible from JP Nagar, Banashankari, and BTM.",
  },
  "sell-gold-indiranagar": {
    description: "Central East Bangalore's most connected suburb.",
    directions:
      "On 100 Feet Road, Indiranagar — near Domlur flyover and HAL Airport Road.",
  },
  "sell-gold-koramangala": {
    description: "The hub of Central Bangalore, close to HSR and BTM.",
    directions:
      "Near Koramangala 1st Block, accessible from Ejipura and Sony World signal.",
  },
  "sell-gold-whitefield": {
    description: "East Bangalore's growing tech and residential corridor.",
    directions:
      "Near ITPL Main Road, accessible from Marathahalli and Varthur.",
  },
  "sell-gold-jp-nagar": {
    description: "Southern Bangalore close to Bannerghatta Road.",
    directions:
      "Near JP Nagar 7th Phase, accessible from Girinagar and Sarakki.",
  },
  "sell-gold-mysore-city": {
    description: "At the heart of Mysore, near Devaraja Market.",
    directions: "Close to Mysore Palace Road and the main commercial street.",
  },
  "sell-gold-gokulam": {
    description: "A residential area in North-West Mysore.",
    directions:
      "Near Gokulam 3rd Stage, accessible from Kuvempunagar and Srirampura.",
  },
  "sell-gold-vijayanagar-mysore": {
    description: "A growing residential hub in North Mysore.",
    directions:
      "Near Vijayanagar 4th Stage, accessible from Jayalakshmipuram and Nazarbad.",
  },
  "sell-gold-mangalore-city": {
    description: "The commercial centre of Mangalore near Hampankatta.",
    directions:
      "Near Hampankatta circle, accessible from Urwa, Bejai, and Balmatta.",
  },
  "sell-gold-kadri": {
    description: "Close to the Kadri Hills temple area in Mangalore.",
    directions:
      "Near Kadri Park, accessible from Kankanady and Mangalore City centre.",
  },
  "sell-gold-davangere": {
    description: "The commercial heart of Davangere City.",
    directions:
      "Near Davangere main market, accessible from all parts of the city.",
  },
};
  ...
  return {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: `Sell Gold ${branch.city}`,
        item: `https://mkgold.in/${citySlug}`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: `Sell Gold in ${branch.area}`,
        item: `https://mkgold.in/${branch.slug}`,
      },
    ],
  };
}
...
export default async function BranchPage({ params }: Props) {
  ...
  const cityBranches = getBranchesByCity(branch.city).filter(
    (b) => b.slug !== area,
  );
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(localBusinessSchema(branch)),
        }}
      />
      <script
        type="application/ld+json"
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildBreadcrumb(branch)),
        }}
      />
        ...
        <div className="mk-container">
          ...
          >
            ...
            <div>
              ...
              >
                Sell <span style={{ color: "var(--gold)" }}>Gold</span> in{" "}
                {branch.area},{" "}
              ...
              >
                Live MCX rates. XRF purity test. Payment in 30 minutes. Walk in
                today — no appointment needed.
              </p>
            ...
            >
              ...
              {[
                ...
                {
                  label: "Hours",
                  value: `${branch.openHours.days}, ${branch.openHours.time}`,
                },
            ...
            <div>
              ...
              >
                {areaInfo?.description ??
                  `Our ${branch.area} branch is centrally located in ${branch.city}, Karnataka.`}
              </p>
              <p
                style={{
                  fontFamily: "Poppins, sans-serif",
              ...
              >
                {areaInfo?.directions ??
                  `Easily accessible from all parts of ${branch.city}.`}
              </p>
      ...
      <section
        ...
        aria-labelledby={`branch-cta-${branch.slug}`}
      >
        <div className="mk-container">
          <div
          ...
          >
            ...
            >
              Walk into MK Gold{" "}
              <span style={{ color: "var(--gold)" }}>{branch.area}</span> today.
            </h2>
