...
export default function FaqsPage() {
  ...
  async function handleDelete(faq: FaqRow) {
    ...
    await fetch(`/api/admin/faqs?id=${faq.id}&page=${tab}`, {
      method: "DELETE",
    });
  }
  ...
  return (
    <div className="mk-admin-page">
      ...
      <p className="mk-admin-subtitle">
        Edit FAQ content shown on the public website. Changes go live
        immediately.
      </p>
      ...
      <div className="mk-admin-section" style={{ marginTop: "var(--s-4)" }}>
        {loading ? (
          ...
          <p className="mk-admin-muted">
            No FAQs yet for this section. Add one below.
          </p>
        ) : (
          <div
                  ...
                  >
                    ...
                    >
                      <label
                        ...
                        title={
                          faq.is_active ? "Click to hide" : "Click to show"
                        }
                      >
                        <input
                          type="checkbox"
        ...
        {addOpen ? (
          ...
          >
            <p className="mk-admin-label" style={{ margin: 0 }}>
              New FAQ — {TABS.find((t) => t.key === tab)?.label}
            </p>
            <div>
              <label className="mk-admin-label">Question</label>
              <input
