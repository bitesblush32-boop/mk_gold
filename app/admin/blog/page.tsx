    ...
    <div className="mk-admin-page">
      ...
      >
        {loading ? (
          ...
          <p className="mk-admin-muted" style={{ padding: "var(--s-6)" }}>
            No posts yet.{" "}
            <Link href="/admin/blog/new" className="mk-admin-link">
              Write one.
            </Link>
          </p>
        ) : (
              ...
              <tbody>
                {posts.map((post) => (
                  <tr key={post.id} className="mk-admin-table-row">
                    ...
                    <td>
                      <span className="mk-admin-category-tag">
                        {post.category}
                      </span>
                    </td>
                    <td>
                    ...
                    <td>
                      ...
                      >
                        <span
                          className={`mk-admin-status mk-admin-status--${post.published ? "published" : "draft"}`}
                        >
