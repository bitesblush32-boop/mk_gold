...
const GOLD_TYPES = ["Jewellery", "Coins", "Bars", "Mixed / Not sure"];
  ...
  if (success) {
    ...
    return (
      <div className="mk-appt-success reveal in">
        <div className="mk-appt-success__check" aria-hidden="true">
          ✓
        </div>
        <h3 className="mk-appt-success__title">Appointment Requested</h3>
        <p className="mk-appt-success__body">
          Thank you, <strong>{form.name}</strong>. We&apos;ve received your slot
          request for <strong>{form.slot_date}</strong> at{" "}
          <strong>{form.slot_time}</strong>
          {branch ? ` at our ${branch.area} branch` : ""}. Our team will confirm
          via WhatsApp or call within a few hours.
        </p>
    ...
    <form className="mk-appt-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className="mk-appt-form__row">
        ...
        <div className="mk-appt-form__field">
          ...
          />
          {errors.phone && (
            <p className="mk-appt-form__error">{errors.phone}</p>
          )}
        </div>
      </div>
      ...
      <div className="mk-appt-form__row">
        ...
        <div className="mk-appt-form__field">
          ...
          >
            <option value="">
              {form.city ? "Select branch" : "Select city first"}
            </option>
            {branches.map((b) => (
          ...
          {errors.branch_slug && (
            <p className="mk-appt-form__error">{errors.branch_slug}</p>
          )}
        </div>
      </div>
      ...
      <div className="mk-appt-form__row">
        <div className="mk-appt-form__field">
          ...
          />
          {errors.slot_date && (
            <p className="mk-appt-form__error">{errors.slot_date}</p>
          )}
        </div>
        ...
        <div className="mk-appt-form__field">
          ...
          {errors.slot_time && (
            <p className="mk-appt-form__error">{errors.slot_time}</p>
          )}
        </div>
      </div>

      {serverErr && <p className="mk-appt-form__server-error">{serverErr}</p>}
