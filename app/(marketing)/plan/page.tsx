    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Get an instant, accurate estimate for your gold — based on the MK
            Gold buying rate, your purity, and weight. No obligation, just
            clarity.
          </p>
        </div>
      </section>
      ...
      {/* Calculator */}
      <section
        className="mk-bg-dark section--sm"
