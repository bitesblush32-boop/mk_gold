...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Gold Buying Guide | Expert Insights | MK Gold",
    description:
      "Expert tips on gold rates, selling, and pledged gold from MK Gold.",
  ...
  return (
    <main>
      ...
      <section
        ...
        style={{
          paddingTop: "calc(var(--chrome-h) + var(--s-5))",
      ...
      >
        <div className="mk-container">
          <div className="reveal" style={{ maxWidth: "640px" }}>
            ...
            >
              Gold Buying <span style={{ color: "var(--gold)" }}>Guide</span>
            </h1>
            <p
              style={{
            ...
            >
              Expert insights on gold rates, selling tips, and market news from
              MK Gold.
            </p>
          </div>
        </div>
          ...
          <div className="mk-container">
            ...
            <article className="mk-blog-featured reveal delay-1">
              ...
              <div className="mk-blog-featured__content">
                ...
                <h2 className="mk-blog-featured__title">{featured.title}</h2>
