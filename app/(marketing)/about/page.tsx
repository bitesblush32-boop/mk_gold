...
const ORG_SCHEMA = {
  ...
  sameAs: [
    "https://www.instagram.com/mkgold.in",
    "https://www.facebook.com/mkgold.in",
  ],
};
        ...
        <div className="mk-container">
          ...
          >
            ...
            <div>
              ...
              >
                A name customers turn to during some of life&apos;s most
            ...
            <div
              className="mk-about-hero-visual"
              style={{
                display: "flex",
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  inset: "-20%",
                  background:
                    "radial-gradient(ellipse at center, rgba(223,193,96,0.10) 0%, transparent 68%)",
                  pointerEvents: "none",
                }}
              />
        ...
        <div className="mk-container">
          <div className="mk-about-split reveal">
            ...
            <div className="mk-about-split__left">
              ...
              >
                Trust is not built overnight — it is earned through years of
            ...
            <div className="mk-about-split__right">
              ...
              >
                At MK Gold, trust is not built overnight — it is earned through
                years of honesty, transparency, and respect. With a legacy of
                over 15 years in Bengaluru, MK Gold has become a name customers
                turn to during some of life&apos;s most important financial
                moments.
              </p>
              <p
                style={{
              ...
              >
                Selling gold is often an emotional decision. Many people walk
                into traditional gold-buying stores feeling anxious, uncertain,
                or even judged. MK Gold was built to change that experience
                completely.
              </p>
              ...
              >
                Our purpose goes beyond buying gold. We exist to provide
                immediate financial support with honesty, empathy, and trust —
                helping customers convert their gold into instant liquidity with
                complete confidence.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              Today, MK Gold is evolving with a larger ambition: to become
              Karnataka&apos;s most trusted organised gold buying brand and the
              first name people think of whenever they need a fair and reliable
              gold-selling experience.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mk-container">
          ...
          >
            <MkTrustBlock title="Our Vision" className="reveal delay-1">
              To become the most trusted gold buying brand across Karnataka and
              South India by setting new standards in transparency, fairness,
              and customer trust.
            </MkTrustBlock>

            <MkTrustBlock title="Our Mission" className="reveal delay-2">
              To provide immediate liquidity against gold through transparent
              evaluation, fair pricing, and a respectful, non-judgmental
              customer experience that values people as much as their gold.
            </MkTrustBlock>
          </div>
        </div>
      </section>
        ...
        <div className="mk-container">
          ...
          >
            ...
            >
              ...
              >
                This is not just a tagline. It is our founding promise — that
                the MK Gold name stands for trust, in English and in Kannada, in
                every city and every branch.
              </p>
            </div>
      ...
      <section className="mk-bg-dark section">
        <div className="mk-container">
          ...
          >
            ...
            >
              Our entire process — from weighing to payout — is ISO certified.
              Every transaction is documented, every rate is traceable.
              Certification issued and audited annually.
            </MkTrustBlock>

            <MkTrustBlock
              title="German XRF Spectrometer"
              className="reveal delay-2"
            >
              We use a Bruker S1 Titan XRF spectrometer — the same instrument
              used by refineries worldwide. It reads the exact gold content
              using X-ray fluorescence in under 2 minutes. No acid. No scratch.
          ...
          <div className="mk-city-grid">
            {CITIES.map((city, i) =>
              city.comingSoon ? (
                ...
                >
                  <span
                    className="mk-city-card__count"
                    style={{ color: "var(--mist)", fontSize: "var(--t-h3)" }}
                  >
                    Soon
                  </span>
                  <span
                    className="mk-city-card__unit"
