...
export const metadata: Metadata = {
  ...
  description:
    'Sell gold in Mysore at live MCX rates. MK Gold has 3 branches in Mysore City, Gokulam and Vijayanagar. XRF purity test. Payment in 45 minutes.',
  alternates: { canonical: 'https://mkgold.in/sell-gold-mysore' },
  openGraph: {
    title: 'Sell Gold in Mysore | Best Rate | MK Gold — 3 Branches',
    description:
      'Sell gold in Mysore at live MCX rates. MK Gold has 3 branches. XRF purity test. Payment in 45 minutes.',
