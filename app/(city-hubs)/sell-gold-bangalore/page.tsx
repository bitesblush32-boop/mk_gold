...
export const metadata: Metadata = {
  ...
  description:
    'Sell gold in Bangalore at live MCX rates. MK Gold has 10 branches across Rajajinagar, Malleshwaram, Indiranagar, Koramangala, Whitefield and more. XRF purity test. Payment in 45 minutes.',
  alternates: { canonical: 'https://mkgold.in/sell-gold-bangalore' },
  openGraph: {
    title: 'Sell Gold in Bangalore | Best Rate | MK Gold — 10 Branches',
    description:
      'Sell gold in Bangalore at live MCX rates. MK Gold has 10 branches. XRF purity test. Payment in 45 minutes.',
